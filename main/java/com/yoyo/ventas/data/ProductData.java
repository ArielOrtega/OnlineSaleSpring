...
//CALL `ecommerceyoyodb`.`yoyoProductRegister`
	...
	public Blob[] getImagesProduct(int idProduct) {
		...
		jdbcTemplate.query(sqlSelect, new Object[] {}, (rs, row)-> rs.getBlob(3)).forEach(entry -> images.add(entry));
